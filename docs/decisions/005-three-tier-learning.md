...
*Tier 1(패턴 자동 수정)* 으로 통합 (ERRORS [282]). 현재 런타임 구조는 **catch() 단일 진입점 → Tier 1(패턴·Contextual Bandit) → Tier 2(LLM Sonnet 5)** 의 *2-Tier* (★ 2026-07-04 모델 상향 — ADR 015 · ★ 2026-07-06 Sonnet 5 단일 통일 — ADR 017).
