...
규칙 (사용자 박제):
   ...
   · 자동 수정은 2개 티어: Tier 1(패턴·Bandit, LLM 0) → Tier 2(LLM Opus 4.6).
"""
...
# ── 자동 수정 티어 (정수, 1부터) ─────────────────────────────────────────
LLM_TIER_MODEL = "claude-opus-4-6"   # Tier 2 LLM 실모델 (auto_repair._MODEL 과 일치)
...
TIERS = [
    ...
    },
    {
        "n":        2,
        "name":     "LLM 자동 수정",
        "engine":   "Claude Code SDK · Opus 4.6",
        "uses_llm": True,
...
def telegram_summary() -> str:
    ...
    return (
        ...
        "  Tier 2 = LLM Opus 4.6 (Tier 1 실패 시)\n"
